...
with app.app_context():
    ...
    cities = []
    cities.append(City(name="Istanbul", image="https://www.celebritycruises.com/blog/content/uploads/2022/12/best-time-to-visit-istanbul-hero-cta.jpg",language="Turkish",description="amazing"))
    cities.append(City(name="Paris", image="https://wallpapers.com/images/hd/romantic-eiffel-paris-babqqvmcylchhb6i.webp", language="French", description="The City of Love"))
    cities.append(City(name="Rome", image="https://images.pexels.com/photos/1797161/pexels-photo-1797161.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2", language="Italian", description="Eternal City"))
    cities.append(City(name="Barcelona", image="https://images.unsplash.com/photo-1583422409516-2895a77efded?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80", language="Spanish", description="Vibrant and Cultural"))
    cities.append(City(name="Prague", image="https://a.cdn-hotels.com/gdcs/production131/d1659/aa53e340-f585-11e8-b8fa-0242ac11000d.jpg?impolicy=fcrop&w=1600&h=1066&q=medium", language="Czech", description="Fairytale City"))
    cities.append(City(name="Amsterdam", image="https://www.travelandleisure.com/thmb/FVnQw8F6k79tsfS4TPAxQuICwic=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/amsterdam-nl-AMSTERDAMTG0521-6d2bfaac29704667a950bcf219680640.jpg", language="Dutch", description="Canals and Bicycles"))
    cities.append(City(name="Vienna", image="https://www.travelandleisure.com/thmb/LjkeMsDoZVX1eo5SdPK_uj5guoY=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/vienna-austria-VIENNATG0621-ecb0ee926c2d49c4bce610db594f7405.jpg", language="German", description="City of Music"))
    cities.append(City(name="Athens", image="https://c4.wallpaperflare.com/wallpaper/607/836/982/ancient-history-tourism-ruins-temple-wallpaper-preview.jpg", language="Greek", description="Ancient Capital"))
    cities.append(City(name="Dublin", image="https://i.pinimg.com/564x/b4/ff/d8/b4ffd89bd41e17b082ab64d32d8f9289.jpg", language="English", description="Friendly and Lively"))
    cities.append(City(name="Stockholm", image="https://media.timeout.com/images/105171709/1920/1080/image.jpg", language="Swedish", description="Scandinavian Gem"))
    cities.append(City(name="Budapest", image="https://i.pinimg.com/564x/2e/45/67/2e456776951f1ecad05cb48e157d17e4.jpg", language="Hungarian", description="City of Baths"))
    
    
    cities.append(City(name="Tokyo", image="https://i.pinimg.com/564x/c8/c6/70/c8c67058a55b856c5d3e8754c0efcc61.jpg", language="Japanese", description="Bustling Metropolis"))
    cities.append(City(name="Seoul", image="https://koreankulture.com/wp-content/uploads/Gyeongbokgung-Palace-in-Seoul-South-Korea.jpg", language="Korean", description="Dynamic and Modern"))
    cities.append(City(name="Shanghai", image="https://i.natgeofe.com/n/302104d1-7616-4ba2-8fa4-316a96b9d718/shanghai_travel_2x3.jpg", language="Mandarin", description="Global Financial Hub"))
    cities.append(City(name="Singapore", image="https://subsites-newsroom.imgix.net/sites/pinnews/files/post_main_content_image/2019-07/Singapore%20Image%20Final_0.jpg?ixlib=php-3.3.1&s=599c327224d6caba6391a4fcc057ecd2", language="English", description="Clean and Efficient"))
    cities.append(City(name="Dubai", image="https://lp-cms-production.imgix.net/features/2017/09/dubai-marina-skyline-2c8f1708f2a1.jpg?auto=format&w=1440&h=810&fit=crop&q=75", language="Arabic", description="City of Superlatives"))
    cities.append(City(name="Mumbai", image="https://www.micato.com/wp-content/uploads/2018/09/mumbai-5.jpg.webp", language="Hindi", description="Bollywood and Business"))
    cities.append(City(name="Hong Kong", image="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Hong_Kong_Harbour_Night_2019-06-11.jpg/2880px-Hong_Kong_Harbour_Night_2019-06-11.jpg", language="Cantonese", description="Urban Jungle"))
    ...
    cities.append(City(name="Tel Aviv", image="https://media.timeout.com/images/105434111/1920/1080/image.jpg", language="Hebrew", description="Holy City"))

   
    cities.append(City(name="Cape Town", image="https://upload.wikimedia.org/wikipedia/commons/e/ec/Aerial_View_of_Sea_Point%2C_Cape_Town_South_Africa.jpg", language="English", description="Stunning Natural Beauty"))
    cities.append(City(name="Marrakech", image="https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Marokko0112_%28retouched%29.jpg/1024px-Marokko0112_%28retouched%29.jpg", language="Arabic", description="Exotic and Colorful"))
    cities.append(City(name="Nairobi", image="https://www.andbeyond.com/wp-content/uploads/sites/5/giraffe-and-sky-line-nairobi.jpg", language="Swahili", description="Gateway to Safari"))
    cities.append(City(name="Cairo", image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Flickr_-_HuTect_ShOts_-_Citadel_of_Salah_El.Din_and_Masjid_Muhammad_Ali_%D9%82%D9%84%D8%B9%D8%A9_%D8%B5%D9%84%D8%A7%D8%AD_%D8%A7%D9%84%D8%AF%D9%8A%D9%86_%D8%A7%D9%84%D8%A3%D9%8A%D9%88%D8%A8%D9%8A_%D9%88%D9%85%D8%B3%D8%AC%D8%AF_%D9%85%D8%AD%D9%85%D8%AF_%D8%B9%D9%84%D9%8A_-_Cairo_-_Egypt_-_17_04_2010_%284%29.jpg/2560px-thumbnail.jpg", language="Arabic", description="Pharaonic Wonders"))
    cities.append(City(name="Victoria Falls", image="https://lp-cms-production.imgix.net/image_browser/victoria-falls-aerial-shot.jpg?auto=format&w=1440&h=810&fit=crop&q=75", language="English", description="Spectacular Waterfalls"))
    cities.append(City(name="Zanzibar City", image="https://planetofhotels.com/guide/sites/default/files/styles/big_gallery_image/public/text_gallery/zanzibar-1.jpg", language="Swahili", description="Paradise Island"))
    cities.append(City(name="Cape Coast", image="https://upload.wikimedia.org/wikipedia/commons/a/a0/Cape_Coast_Castle%2C_Cape_Coast%2C_Ghana.JPG", language="English", description="Rich History"))
    cities.append(City(name="Dakar", image="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Ngor_Beach.jpg/1920px-Ngor_Beach.jpg", language="French", description="Vibrant West African Culture"))
    cities.append(City(name="Johannesburg", image="https://media.timeout.com/images/105237782/image.jpg", language="English", description="Economic Powerhouse"))
    cities.append(City(name="Luxor", image="https://cdn.britannica.com/08/178108-050-F19D0A38/statues-entrance-Ramses-II-Luxor-temple-complex.jpg", language="Arabic", description="Ancient Egyptian Treasures"))

   
    cities.append(City(name="Sydney", image="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Sydney_Opera_House_and_Harbour_Bridge_Dusk_%282%29_2019-06-21.jpg/2880px-Sydney_Opera_House_and_Harbour_Bridge_Dusk_%282%29_2019-06-21.jpg", language="English", description="Iconic Landmarks"))
    cities.append(City(name="Auckland", image="https://a.cdn-hotels.com/gdcs/production133/d294/4e4195aa-b9ca-42cd-923f-e8a65c8c5c7b.jpg?impolicy=fcrop&w=800&h=533&q=medium", language="English", description="City of Sails"))
    cities.append(City(name="Melbourne", image="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Melbourne_CBD_and_Princes_Bridge_at_night_%282013%29.jpg/2880px-Melbourne_CBD_and_Princes_Bridge_at_night_%282013%29.jpg", language="English", description="Cultural Melting Pot"))
    cities.append(City(name="Queenstown", image="https://upload.wikimedia.org/wikipedia/commons/c/c9/Queenstown_1_%288168013172%29.jpg", language="English", description="Adventure Capital"))
    cities.append(City(name="Brisbane", image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Sunsets_of_Brisbane%2C_Queensland%2C_September_2021%2C_01.jpg/1920px-Sunsets_of_Brisbane%2C_Queensland%2C_September_2021%2C_01.jpg", language="English", description="Sunshine City"))
    cities.append(City(name="Honolulu", image="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/King_Kamehameha_I_Statue_-_Honolulu_%284_by_3%29.jpg/1920px-King_Kamehameha_I_Statue_-_Honolulu_%284_by_3%29.jpg", language="English", description="Tropical Paradise"))
    cities.append(City(name="Fiji", image="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Lautoka_Streets_20.jpg/2560px-Lautoka_Streets_20.jpg", language="English", description="Idyllic Islands"))
    cities.append(City(name="Suva", image="https://static01.nyt.com/images/2023/05/06/travel/oakImage-1663853463601/oakImage-1663853463601-superJumbo.jpg?quality=75&auto=webp", language="English", description="Cultural Hub"))
    cities.append(City(name="Wellington", image="https://static01.nyt.com/images/2022/12/05/multimedia/05-36hours-wellington-1-0bfb/05-36hours-wellington-1-0bfb-superJumbo.jpg", language="English", description="Coolest Little Capital"))
    cities.append(City(name="Canberra", image="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Canberra_viewed_from_Mount_Ainslie.jpg/2560px-Canberra_viewed_from_Mount_Ainslie.jpg", language="English", description="Seat of Government"))
   

    #north america
    cities.append(City(name="New York City", image="https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/New_york_times_square-terabass.jpg/2560px-New_york_times_square-terabass.jpg", language="English", description="The Big Apple"))
    cities.append(City(name="Los Angeles", image="https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Hollywood_Sign_%28Zuschnitt%29_%28cropped%29.jpg/1920px-Hollywood_Sign_%28Zuschnitt%29_%28cropped%29.jpg", language="English", description="City of Stars"))
    cities.append(City(name="Toronto", image="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Toronto_-_ON_-_Skyline_bei_Nacht.jpg/1920px-Toronto_-_ON_-_Skyline_bei_Nacht.jpg", language="English", description="Cultural Diversity"))
    cities.append(City(name="Mexico City", image="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Chapultepec_castle_in_Mexico_city.jpg/2560px-Chapultepec_castle_in_Mexico_city.jpg", language="Spanish", description="Historic Capital"))
    cities.append(City(name="Vancouver", image="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/A_look_downtown_%28759827996%29.jpg/2560px-A_look_downtown_%28759827996%29.jpg", language="English", description="Outdoor Paradise"))
    cities.append(City(name="San Francisco", image="https://cdn.britannica.com/13/77413-050-95217C0B/Golden-Gate-Bridge-San-Francisco.jpg", language="English", description="Tech Hub"))
    cities.append(City(name="Chicago", image="https://www.travelandleisure.com/thmb/L2dnLH86xwCJfZ8fIVBT2Sp9D9s=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/chicago-illinois-CHITG0221-e448062fc5164da0bba639f9857987f6.jpg", language="English", description="Windy City"))
    cities.append(City(name="Miami", image="https://a.travel-assets.com/findyours-php/viewfinder/images/res70/471000/471674-Miami.jpg", language="English", description="Sunshine Paradise"))
    cities.append(City(name="Montreal", image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Vieux-Montr%C3%A9al_%28525744602%29.jpg/2560px-Vieux-Montr%C3%A9al_%28525744602%29.jpg", language="French", description="European Charm"))
    cities.append(City(name="Seattle", image="https://upload.wikimedia.org/wikipedia/commons/5/58/Seattle_Center_as_night_falls.jpg", language="English", description="Emerald City"))

    #south america
    cities.append(City(name="Rio de Janeiro", image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Cidade_Maravilhosa.jpg/2560px-Cidade_Maravilhosa.jpg", language="Portuguese", description="Carnival City"))
    cities.append(City(name="Buenos Aires", image="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Puerto_Madero%2C_Buenos_Aires_%2840689219792%29_%28cropped%29.jpg/2880px-Puerto_Madero%2C_Buenos_Aires_%2840689219792%29_%28cropped%29.jpg", language="Spanish", description="Cosmopolitan Capital"))
    cities.append(City(name="Sao Paulo", image="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Ponte_Estaiada_e_CENU.jpg/1920px-Ponte_Estaiada_e_CENU.jpg", language="Portuguese", description="Largest City in South America"))
    cities.append(City(name="Lima", image="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Plaza_de_Armas%2C_Lima.jpg/2560px-Plaza_de_Armas%2C_Lima.jpg", language="Spanish", description="Historic and Culinary Hub"))
    cities.append(City(name="Bogota", image="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Colegio_Mayor_de_San_Bartolom%C3%A9%2C_Plaza_de_Bol%C3%ADvar.jpg/1920px-Colegio_Mayor_de_San_Bartolom%C3%A9%2C_Plaza_de_Bol%C3%ADvar.jpg", language="Spanish", description="Andean Capital"))
    cities.append(City(name="Santiago", image="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/2019-04-06-12h10m43.jpg/1920px-2019-04-06-12h10m43.jpg", language="Spanish", description="Modern and Progressive"))
    cities.append(City(name="Cartagena", image="https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Amarillo_Latente.jpg/2560px-Amarillo_Latente.jpg", language="Spanish", description="Colonial Gem"))
    cities.append(City(name="Quito", image="https://upload.wikimedia.org/wikipedia/commons/5/58/Iglesia_de_San_Francisco%2C_Quito%2C_Ecuador%2C_2015-07-22%2C_DD_171-173_HDR.JPG", language="Spanish", description="High in the Andes"))
    cities.append(City(name="Salvador", image="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Vulkan_Chaparrastique%2C_El_Salvador_2013_01.JPG/2560px-Vulkan_Chaparrastique%2C_El_Salvador_2013_01.JPG", language="Portuguese", description="Cultural Center"))
    cities.append(City(name="Lisbon", image="https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Lisbon_%2836831596786%29_%28cropped%29.jpg/2560px-Lisbon_%2836831596786%29_%28cropped%29.jpg", language="Portuguese", description="Capital of Portugal, but located in South America"))
