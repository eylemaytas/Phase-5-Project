...
with app.app_context():
    ...
    # Istanbul
    foods.append(Food(name="Kebap", image="https://modern.techinfus.com/photo_l/foto-1924-0.jpg", description="Authentic Turkish kebap.", restaurant_recommendation="Eylemin Yeri", city_id=1))
    foods.append(Food(name="Baklava", image="https://i.pinimg.com/564x/7f/8b/00/7f8b00c4afeb5ce2c4387937c617ebc3.jpg", description="Sweet pastry with nuts and honey.", restaurant_recommendation="Hafiz Mustafa", city_id=1))
    ...
    foods.append(Food(name="Butter Chicken", image="https://i.pinimg.com/564x/d1/ac/a5/d1aca5bb93bb89190cd30a8d3146d46f.jpg", description="Creamy and flavorful chicken curry.", restaurant_recommendation="Punjab Grill", city_id=17))
    ...
    # Cairo
    foods.append(Food(name="Koshari", image="https://i.pinimg.com/564x/50/de/01/50de01f4f97ef0211920d957bc49fe19.jpg", description="Egyptian comfort food with rice, lentils, pasta, and a spiced tomato sauce.", restaurant_recommendation="Abou Tarek", city_id=24))
    foods.append(Food(name="Ful Medames", image="https://i.pinimg.com/564x/be/d6/3e/bed63ea60cb81e62f3d8ec81e5596e25.jpg", description="Stewed fava beans served with toppings and bread.", restaurant_recommendation="Felfela", city_id=24))
    foods.append(Food(name="Kofta", image="https://i.pinimg.com/564x/e6/d4/e2/e6d4e2c92086a94f8f37646bbd22b5ad.jpg", description="Grilled or baked ground meat skewers, often served with rice or bread.", restaurant_recommendation="Kebdet El Prince", city_id=24))

    # Victoria Falls
    foods.append(Food(name="Bream Fish", image="https://i.pinimg.com/564x/fe/2f/40/fe2f40dc3401776ef93ecfe96bd80e7d.jpg", description="Freshwater fish commonly found in the Zambezi River, usually grilled or fried.", restaurant_recommendation="The Boma - Dinner & Drum Show", city_id=25))
    foods.append(Food(name="Sadza", image="https://i.pinimg.com/564x/bb/a9/3d/bba93d6efdb2653e585f64f372e74c9f.jpg", description="Staple food made from finely ground cornmeal, similar to polenta.", restaurant_recommendation="Mama Africa Eating House", city_id=25))
    foods.append(Food(name="Game Meat", image="https://harvestingnature.com/wp-content/uploads/2022/12/Photo-Dec-18-2022-22-02-08-scaled.jpg", description="Various types of wild game meat, such as kudu or warthog, often prepared as steaks or stews.", restaurant_recommendation="The Smoke that Thunders", city_id=25))

    # Zanzibar City
    foods.append(Food(name="Zanzibar Pizza", image="https://swahilifood.com/wp-content/uploads/2019/04/IMG_0084-scaled-e1596965122470.jpg", description="Thin and crispy stuffed pancakes with various fillings like seafood, meat, or vegetables.", restaurant_recommendation="Forodhani Night Market", city_id=26))
    foods.append(Food(name="Octopus Curry", image="https://i.pinimg.com/564x/41/4e/05/414e05635acba43a015c9704eca06c7f.jpg", description="Spicy curry dish made with tender octopus and flavorful spices.", restaurant_recommendation="Café Miwa", city_id=26))
    foods.append(Food(name="Urojo Soup", image="https://miro.medium.com/v2/resize:fit:4800/format:webp/1*wqN3OaZqV32PCNcgIucRqg.jpeg", description="Tangy and savory soup with a mix of ingredients like potatoes, lentils, and fried snacks.", restaurant_recommendation="Zanzibar Delights", city_id=26))
    ...
    foods.append(Food(name="Grilled Lobster", image="https://i.pinimg.com/564x/0b/2f/c9/0b2fc9903ca68b5dbdfc64bb9e344d9c.jpg", description="Freshly caught lobster grilled to perfection, often served with spicy sauces.", restaurant_recommendation="Biriwa Beach Hotel", city_id=27))
    ...
    # Dakar
    foods.append(Food(name="Thieboudienne", image="https://i.pinimg.com/564x/3b/e5/9f/3be59ff5fde097ad806a1b63b3cec813.jpg", description="National dish of Senegal, a flavorful rice and fish stew with vegetables.", restaurant_recommendation="Chez Loutcha", city_id=28))
    foods.append(Food(name="Yassa Poulet", image="https://i.pinimg.com/564x/3a/8d/c2/3a8dc2c1b1d115d4528b3d7402ecdb40.jpg", description="Chicken marinated in tangy onion and lemon sauce, often served with rice.", restaurant_recommendation="La Calebasse", city_id=28))
    foods.append(Food(name="Mafe", image="https://i.pinimg.com/564x/98/07/fc/9807fc7605598ceb066adf76c7ea9522.jpg", description="Peanut butter stew with meat or vegetables, served with couscous or rice.", restaurant_recommendation="Chez Fatou", city_id=28))

    # Johannesburg
    foods.append(Food(name="Braai", image="https://i.pinimg.com/564x/73/a6/af/73a6afb290f0d6c905aa42381940b54b.jpg", description="South African barbecue featuring grilled meat, sausages, and vegetables.", restaurant_recommendation="Mzoli's", city_id=29))
    foods.append(Food(name="Bunny Chow", image="https://i.pinimg.com/564x/a3/85/1f/a3851f62b5bad3a7f9a11c71dbbf77c6.jpg", description="Hollowed-out loaf of bread filled with curry, a popular street food.", restaurant_recommendation="House of Nsangu", city_id=29))
    foods.append(Food(name="Malva Pudding", image="https://i.pinimg.com/564x/7c/36/5f/7c365f8866f67c783cac0c7f8db7674c.jpg", description="Sweet and sticky baked sponge pudding with apricot jam, often served with custard.", restaurant_recommendation="Sophiatown Bar Lounge", city_id=29))

    # Luxor
    foods.append(Food(name="Koshari", image="https://i.pinimg.com/564x/e3/f2/c6/e3f2c600edee3c37d4434b563ea5aca1.jpg", description="Egyptian comfort food with rice, lentils, pasta, and a spiced tomato sauce.", restaurant_recommendation="Abou Shakra", city_id=30))
    foods.append(Food(name="Ful Medames", image="https://i.pinimg.com/564x/46/12/b9/4612b9680751354f038a6981604969c9.jpg", description="Stewed fava beans served with toppings and bread.", restaurant_recommendation="Hoda Restaurant", city_id=30))
    foods.append(Food(name="Taameya", image="https://i.pinimg.com/564x/a4/5d/16/a45d16e96b5093e9d245f2f00761c1f1.jpg", description="Egyptian falafel made from mashed fava beans or chickpeas.", restaurant_recommendation="El Hussein", city_id=30))

    # Sydney
    foods.append(Food(name="Fish and Chips", image="https://media.timeout.com/images/105728822/1920/1080/image.jpg", description="Classic dish of battered fish and crispy fries.", restaurant_recommendation="Sydney Fish Market", city_id=31))
    foods.append(Food(name="Meat Pie", image="https://imgix.theurbanlist.com/content/general/best-pies-sydney-2021.jpg?auto=format,compress&w=740&h=486&fit=crop", description="Savory pie filled with minced meat and gravy.", restaurant_recommendation="Harry's Cafe de Wheels", city_id=31))
    foods.append(Food(name="Pavlova", image="https://i.pinimg.com/564x/c1/bd/6a/c1bd6a22284d59674e3ddf44061f2608.jpg", description="Dessert made of meringue, whipped cream, and fresh fruits.", restaurant_recommendation="Black Star Pastry", city_id=31))

    # Auckland
    foods.append(Food(name="Hangi", image="https://supervalue.imgix.net/assets/recipes/iStock-516816688.jpg?&ch=Width,DPR&fit=crop&auto=format%2C%20compress&q=70", description="Traditional Maori dish of meat and vegetables cooked in an earth oven.", restaurant_recommendation="Hangi Master", city_id=32))
    foods.append(Food(name="Pork Belly", image="https://i.pinimg.com/564x/82/06/43/8206436d0f2e7ecb9ad785366f993f11.jpg", description="Slow-cooked pork belly with crispy crackling, often served with roasted vegetables.", restaurant_recommendation="The Grove", city_id=32))
    foods.append(Food(name="Pavlova", image="https://i.pinimg.com/564x/c1/bd/6a/c1bd6a22284d59674e3ddf44061f2608.jpg", description="Dessert made of meringue, whipped cream, and fresh fruits.", restaurant_recommendation="Moustache Milk & Cookie Bar", city_id=32))

    # Melbourne
    foods.append(Food(name="Chicken Parmigiana", image="https://media.timeout.com/images/105725924/1920/1080/image.jpg", description="Breaded chicken cutlet topped with tomato sauce and melted cheese, served with fries or salad.", restaurant_recommendation="The Pub", city_id=33))
    foods.append(Food(name="Lamb Roast", image="https://i.pinimg.com/564x/4c/6c/83/4c6c831162041b01afbdc8691849124d.jpg", description="Slow-roasted lamb with herbs and spices, often served with roasted vegetables and gravy.", restaurant_recommendation="The Meat & Wine Co", city_id=33))
    foods.append(Food(name="Vanilla Slice", image="https://i.pinimg.com/564x/5b/46/54/5b465406d16042ab059259abda439600.jpg", description="Pastry dessert with layers of custard and puff pastry, topped with icing.", restaurant_recommendation="Bourke Street Bakery", city_id=33))

    # Queenstown
    foods.append(Food(name="Fergburger", image="https://media-cdn.tripadvisor.com/media/photo-s/06/5d/25/90/fergburger.jpg", description="Iconic burger filled with a variety of toppings and sauces.", restaurant_recommendation="Fergburger", city_id=34))
    foods.append(Food(name="Venison", image="https://www.saveur.com/uploads/2018/12/18/52L6W7ML34KL4YCAVTIILLVDYI.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=1440", description="Tender and flavorful deer meat, often served as steaks or in stews.", restaurant_recommendation="Rata Dining", city_id=34))
    foods.append(Food(name="Hokey Pokey Ice Cream", image="https://icecreamfromscratch.com/wp-content/uploads/2022/12/Hokey-Pokey-Ice-Cream-1.2.jpg", description="New Zealand's classic ice cream flavor with caramelized honeycomb toffee pieces.", restaurant_recommendation="Patagonia Chocolates", city_id=34))
    ...
    foods.append(Food(name="Prawn Cocktail", image="https://i.pinimg.com/564x/b2/9b/0f/b29b0f26f8db14076002a6763f2fe6ca.jpg", description="Chilled prawns served with a tangy cocktail sauce and lettuce.", restaurant_recommendation="Cha Cha Char Wine Bar & Grill", city_id=35))
    foods.append(Food(name="Tim Tam", image="https://assets.bonappetit.com/photos/5888f63dc60fe15a61297432/4:3/w_3699,h_2774,c_limit/chewy-caramel-tim-tam.jpg", description="Chocolate-coated biscuit with a creamy filling, a beloved Australian treat.", restaurant_recommendation="Woolworths", city_id=35))

    # Honolulu
    foods.append(Food(name="Poke Bowl", image="https://www.hawaiimagazine.com/content/uploads/2020/12/5bestpoke-foodland.png", description="Hawaiian dish with diced raw fish, rice, and various toppings.", restaurant_recommendation="Ono Seafood", city_id=36))
    foods.append(Food(name="Kalua Pig", image="https://www.cookingclassy.com/wp-content/uploads/2020/05/kalua-pork-1.jpg", description="Slow-roasted pig cooked in an underground oven, a traditional Hawaiian luau dish.", restaurant_recommendation="Kono's North Shore", city_id=36))
    foods.append(Food(name="Shave Ice", image="https://i.pinimg.com/564x/2a/b0/bc/2ab0bcc8eb3ecacf4206265d3c389fcb.jpg", description="Flavored shaved ice topped with syrup and various toppings, a refreshing treat.", restaurant_recommendation="Matsumoto Shave Ice", city_id=36))

    # Fiji
    foods.append(Food(name="Lovo", image="https://www.sbs.com.au/food/sites/sbs.com.au.food/files/styles/full/public/lovofijianfeastcookedintheearth_0.jpg?itok=9Ny6s6P3&mtime=1541553830", description="Traditional Fijian feast cooked in an underground oven, featuring meats, fish, and vegetables.", restaurant_recommendation="Namosi Highland Picnic", city_id=37))
    foods.append(Food(name="Kokoda", image="https://www.saveur.com/uploads/2019/02/08/DUCNM4MDNXXYW7HUTIHWWKN5AM.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=1440", description="Fijian ceviche made with raw fish marinated in coconut milk and citrus juices.", restaurant_recommendation="Indigo Indian Asian Restaurant", city_id=37))
    foods.append(Food(name="Cassava Cake", image="https://i.pinimg.com/564x/49/c3/23/49c32380a73b2ee2989ec5e63d5660b4.jpg", description="Dessert made from grated cassava, coconut milk, and sugar, often served with coconut cream.", restaurant_recommendation="Nadina Authentic Fijian Restaurant", city_id=37))

    # Suva
    foods.append(Food(name="Palusami", image="https://i.pinimg.com/564x/01/18/cc/0118ccf5c3530bcafa57dc7e6ce3d13f.jpg", description="Taro leaves filled with coconut cream and onions, cooked in an underground oven.", restaurant_recommendation="Daikoku Fiji", city_id=38))
    foods.append(Food(name="Kokoda", image="https://i.pinimg.com/564x/ba/69/66/ba696672c37b9ecfdd3dd5c00d316e4e.jpg", description="Fijian ceviche made with raw fish marinated in coconut milk and citrus juices.", restaurant_recommendation="Rewa Café", city_id=38))
    foods.append(Food(name="Fried Rice", image="https://i.pinimg.com/564x/a8/f1/93/a8f1935a5caf89b347ca11f9e791100c.jpg", description="Stir-fried rice with vegetables, meat, and/or seafood, a popular Chinese-inspired dish.", restaurant_recommendation="Tai's Place", city_id=38))

    # Wellington
    foods.append(Food(name="Hangi Pie", image="https://iconiceats.co.nz/wp-content/uploads/2021/08/BlueRose01-2048x1365.jpg", description="Meat and vegetable pie with flavors inspired by traditional Maori hangi.", restaurant_recommendation="The British Pie Shop", city_id=39))
    foods.append(Food(name="Whitebait Fritter", image="https://d3lp4xedbqa8a5.cloudfront.net/s3/digital-cougar-assets/food/2016/09/26/35319/whitebait-fritters.jpg?width=922&height=768&mode=crop&anchor=topcenter&quality=75", description="Egg-battered fritter filled with tiny whitebait fish, a classic New Zealand delicacy.", restaurant_recommendation="Maranui Café", city_id=39))
    foods.append(Food(name="Kiwifruit Pavlova", image="https://img.taste.com.au/iGAw1TLs/w720-h480-cfill-q80/taste/2016/11/kiwi-passionfruit-pavlova-79408-1.jpeg", description="Pavlova dessert topped with slices of kiwifruit, a popular New Zealand fruit.", restaurant_recommendation="Sweet Bakery and Cakery", city_id=39))

    # Canberra
    foods.append(Food(name="Barramundi", image="https://media.blueapron.com/recipes/1944/square_newsletter_images/1478273125-4-4502/111418_2PF_Barramundi-RESHOOT-0144_SQ.jpg?quality=80&width=850&format=pjpg", description="Popular Australian fish known for its sweet and buttery flavor, often grilled or fried.", restaurant_recommendation="Pialligo Estate", city_id=40))
    foods.append(Food(name="Australian Meat Pie", image="https://www.wandercooks.com/wp-content/uploads/2020/10/australian-meat-party-pies-5.jpg", description="Individual-sized savory pie filled with minced meat and gravy, a classic Australian snack.", restaurant_recommendation="Gus' Cafe", city_id=40))
    foods.append(Food(name="Lamington", image="https://www.thespruceeats.com/thmb/u_JVYFPo9KHEkYaRiKF8RLU-gJc=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/SES-lamington-cake-recipe-256086-b7ee6d18303c423db87bf0752419de02.jpg", description="Sponge cake coated in chocolate icing and desiccated coconut, a beloved Australian treat.", restaurant_recommendation="Dobinsons Bakery Cafe", city_id=40))

    # New York City
    foods.append(Food(name="New York-style Pizza", image="https://i.pinimg.com/564x/fb/55/55/fb555527058ecad1797448c022780071.jpg", description="Large, thin-crust pizza with classic toppings like cheese, pepperoni, and tomato sauce.", restaurant_recommendation="Joe's Pizza", city_id=41))
    foods.append(Food(name="Pastrami Sandwich", image="https://i.pinimg.com/564x/5a/5a/07/5a5a078c367bbde173594c491f21f7ea.jpg", description="Hearty sandwich filled with thinly sliced, smoky pastrami, usually served on rye bread with mustard.", restaurant_recommendation="Katz's Delicatessen", city_id=41))
    foods.append(Food(name="Cheesecake", image="https://i.pinimg.com/564x/c4/57/97/c45797743e0f1d95b30a98e80cbbda19.jpg", description="Rich and creamy dessert made with cream cheese, eggs, and a graham cracker crust.", restaurant_recommendation="Junior's", city_id=41))

    # Los Angeles
    foods.append(Food(name="Taco", image="https://i.pinimg.com/564x/5c/76/b9/5c76b97473ba7ae1ef9ba34df9ff15bb.jpg", description="Mexican street food staple consisting of a tortilla filled with various ingredients like grilled meat, salsa, and guacamole.", restaurant_recommendation="Guisados", city_id=42))
    foods.append(Food(name="Korean BBQ", image="https://i.pinimg.com/564x/70/9e/43/709e43d24978438610df8b1a35db066f.jpg", description="Grilled marinated meats, typically beef, served with rice, kimchi, and other side dishes.", restaurant_recommendation="Park's BBQ", city_id=42))
    foods.append(Food(name="Acai Bowl", image="https://i.pinimg.com/564x/72/9d/4a/729d4a7d3e97d781123af1ec06bc7905.jpg", description="Healthy breakfast bowl made with acai berries, topped with granola, fruits, and honey.", restaurant_recommendation="Backyard Bowls", city_id=42))

    # Toronto
    foods.append(Food(name="Peameal Bacon Sandwich", image="https://www.cbc.ca/stevenandchris/content/images/roasted_peameal_bacon_sandwich.jpg", description="Sandwich made with peameal bacon, a type of Canadian bacon, often served on a bun with mustard.", restaurant_recommendation="Carousel Bakery", city_id=43))
    foods.append(Food(name="Poutine", image="https://media.timeout.com/images/105451314/1920/1080/image.jpg", description="Classic Canadian dish of french fries topped with cheese curds and smothered in gravy.", restaurant_recommendation="Smoke's Poutinerie", city_id=43))
    foods.append(Food(name="Butter Tart", image="https://www.biggerbolderbaking.com/wp-content/uploads/2021/03/Canadian-Butter-Tarts-scaled.jpg", description="Sweet pastry tart filled with a gooey mixture of butter, sugar, and eggs.", restaurant_recommendation="Le Gourmand", city_id=43))

    # Mexico City
    foods.append(Food(name="Tacos al Pastor", image="https://www.jocooks.com/wp-content/uploads/2022/04/tacos-al-pastor-feature-1.jpg", description="Marinated pork tacos topped with pineapple, onion, and cilantro.", restaurant_recommendation="El Huequito", city_id=44))
    foods.append(Food(name="Chiles en Nogada", image="https://assets.elgourmet.com/wp-content/uploads/2023/03/BO5RnJFRWk8aNcMETODOSXVNiGbXQVPX4Mp-1024x683.png.webp", description="Stuffed poblano peppers topped with walnut sauce and pomegranate seeds, a traditional Mexican dish.", restaurant_recommendation="El Cardenal", city_id=44))
    foods.append(Food(name="Mexican Street Corn (Elote)", image="https://cookieandkate.com/images/2020/08/elote-recipe-2.jpg", description="Grilled corn on the cob coated with mayo, cheese, chili powder, and lime juice.", restaurant_recommendation="Elote Man", city_id=44))

    # Vancouver
    foods.append(Food(name="Salmon Sushi", image="https://tryhiddengems.com/wp-content/uploads/VancouverAburiSushi6-1024x576.jpg", description="Fresh salmon sashimi or nigiri sushi, a popular seafood delicacy in Vancouver.", restaurant_recommendation="Miku", city_id=45))
    foods.append(Food(name="Japadog", image="https://www.yvr.ca/-/media/yvr/blog/2022/japadog/88_yvr_japadog_march3_2022.jpg", description="Japanese-style hot dog topped with unique toppings like teriyaki sauce, seaweed, and Japanese mayo.", restaurant_recommendation="Japadog", city_id=45))
    foods.append(Food(name="Nanaimo Bar", image="https://montecristomagazine.com/wp-content/uploads/2021/04/NanaimoRecipe-1.jpg", description="Layered dessert bar with a chocolate-coconut base, custard filling, and chocolate ganache on top.", restaurant_recommendation="Butter Baked Goods", city_id=45))

    # San Francisco
    foods.append(Food(name="Cioppino", image="https://diethood.com/wp-content/uploads/2021/01/Cioppino-6.jpg", description="Seafood stew made with a variety of fish and shellfish, usually served with crusty bread.", restaurant_recommendation="Tadich Grill", city_id=46))
    foods.append(Food(name="Mission Burrito", image="https://www.seriouseats.com/thmb/00BXhhQBN0wQN6-TajgPYXjd8n0=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/20191002-san-francisco-burritos-TaqueriaGuadalejara-lori-eanes-9762fdae2ecd47e6927d51805760b1b1.jpg", description="Large, overstuffed burrito filled with ingredients like rice, beans, meat, salsa, and guacamole.", restaurant_recommendation="La Taqueria", city_id=46))
    foods.append(Food(name="Sourdough Bread", image="https://heartbeetkitchen.com/foodblog/wp-content/uploads/2020/04/basic-sourdough-bread-recipe4.jpg", description="Tangy and crusty bread made from naturally fermented dough, a San Francisco specialty.", restaurant_recommendation="Boudin Bakery", city_id=46))

    # Chicago
    foods.append(Food(name="Deep Dish Pizza", image="https://www.thecookierookie.com/wp-content/uploads/2023/05/Chicago-Style-Deep-Dish-Pizza-4-edited.jpg", description="Thick, deep-dish pizza with a buttery crust, gooey cheese, and chunky tomato sauce.", restaurant_recommendation="Lou Malnati's Pizzeria", city_id=47))
    foods.append(Food(name="Chicago-style Hot Dog", image="https://static01.nyt.com/images/2022/07/27/dining/27Chicagodogrex/05Chicagodogrex-articleLarge.jpg", description="All-beef hot dog topped with mustard, onions, relish, tomato slices, pickle spear, sport peppers, and celery salt, served on a poppy seed bun.", restaurant_recommendation="Portillo's", city_id=47))
    foods.append(Food(name="Italian Beef Sandwich", image="https://www.wellplated.com/wp-content/uploads/2021/04/Italian-Beef-Recipe.jpg", description="Thinly sliced roast beef piled on a crusty roll and dipped in flavorful gravy, a Chicago classic.", restaurant_recommendation="Al's Beef", city_id=47))

    # Miami
    foods.append(Food(name="Cuban Sandwich", image="https://www.seriouseats.com/thmb/DMduS_tw16ftsr8NJq7NHqUTfb4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/cuban-sandwich-recipe-Hero-5833ef16ac3f4ebe99fb3156c9fe2e0c.jpg", description="Grilled sandwich with ham, roasted pork, Swiss cheese, pickles, and mustard, pressed on Cuban bread.", restaurant_recommendation="Versailles Restaurant", city_id=48))
    foods.append(Food(name="Key Lime Pie", image="https://i0.wp.com/www.livewellbakeoften.com/wp-content/uploads/2021/05/Key-Lime-Pie-NEW.jpg?w=1200&ssl=1", description="Tangy and creamy pie made with key lime juice and a graham cracker crust.", restaurant_recommendation="Joe's Stone Crab", city_id=48))
    foods.append(Food(name="Stone Crab", image="https://media.timeout.com/images/104085872/1920/1080/image.jpg", description="Freshly caught stone crab claws served chilled with mustard sauce, a popular seafood delicacy in Miami.", restaurant_recommendation="Joe's Stone Crab", city_id=48))

    # Montreal
    foods.append(Food(name="Poutine", image="https://indie88.com/wp-content/uploads/2018/09/poutine.jpg", description="Classic Canadian dish of french fries topped with cheese curds and smothered in gravy.", restaurant_recommendation="La Banquise", city_id=49))
    foods.append(Food(name="Smoked Meat Sandwich", image="https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Schwartz_smoked_meat_montreal.JPG/2560px-Schwartz_smoked_meat_montreal.JPG", description="Sandwich made with flavorful smoked meat, typically served on rye bread with mustard.", restaurant_recommendation="Schwartz's Deli", city_id=49))
    foods.append(Food(name="Bagels", image="https://i0.wp.com/www.onceuponachef.com/images/2022/05/MontrealBagels_0263-scaled.jpg?resize=1365%2C2048&ssl=1", description="Chewy and slightly sweet bagels, often topped with sesame seeds and served with cream cheese and smoked salmon.", restaurant_recommendation="Fairmount Bagel", city_id=49))

    # Seattle
    foods.append(Food(name="Seattle-style Hot Dog", image="https://www.thespruceeats.com/thmb/R3ImDoIX7zI1vWMmcOA4Yg9cNUg=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/seattle-hot-dogs-4773446-Hero-01-394711d96fc34b569634bd6497dbd796.jpg", description="Hot dog topped with cream cheese, grilled onions, and sautéed onions, a unique Seattle twist.", restaurant_recommendation="Monster Dogs", city_id=50))
    foods.append(Food(name="Salmon Chowder", image="https://images.themodernproper.com/billowy-turkey/production/posts/2019/salmon-chowder-14.jpg?w=1200&q=82&fm=jpg&fit=crop&dm=1684213205&s=b920dd0a2afd7fda1a420d08309d29bf", description="Creamy chowder made with fresh salmon, potatoes, and vegetables, a Pacific Northwest specialty.", restaurant_recommendation="Pike Place Chowder", city_id=50))
    foods.append(Food(name="Dungeness Crab", image="https://www.foodiecrush.com/wp-content/uploads/2016/11/The-Easiest-Dungeness-Crab-Recipe-foodiecrush.com-0011.jpg", description="Sweet and flavorful crab, often served steamed or in various seafood dishes, a local delicacy in Seattle.", restaurant_recommendation="The Crab Pot", city_id=50))

    # Rio de Janeiro
    foods.append(Food(name="Feijoada", image="https://i.pinimg.com/564x/ab/14/59/ab14591fedcf4bf5632e489dbad68725.jpg", description="Rich and hearty black bean stew with various cuts of pork and served with rice, collard greens, and farofa.", restaurant_recommendation="Casa da Feijoada", city_id=51))
    foods.append(Food(name="Coxinha", image="https://blog.amigofoods.com/wp-content/uploads/2019/09/brazilian-chicken-coxinha.jpg", description="Deep-fried dough filled with shredded chicken and cream cheese, a popular Brazilian snack.", restaurant_recommendation="Bar do Mineiro", city_id=51))
    foods.append(Food(name="Caipirinha", image="https://www.liquor.com/thmb/W0TdVI7hFql6gfp8XazymQ8mqQs=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/caipirnha-720x720-primary-40900f56782b4c1d8c79494c9b413f9c.jpg", description="Refreshing cocktail made with cachaça, sugar, and lime, Brazil's national drink.", restaurant_recommendation="Jobi", city_id=51))

    # Buenos Aires
    foods.append(Food(name="Asado", image="https://media.tacdn.com/media/attractions-splice-spp-674x446/0a/32/47/0f.jpg", description="Argentine-style barbecue with various cuts of grilled meat, often served with chimichurri sauce.", restaurant_recommendation="La Brigada", city_id=52))
    foods.append(Food(name="Empanadas", image="https://assets.bonappetit.com/photos/58a34e1df12ac6e639bf24ae/1:1/w_2240,c_limit/argentinian-beef-empanadas.jpg", description="Savory pastries filled with meat, cheese, or vegetables, a popular street food in Argentina.", restaurant_recommendation="El Sanjuanino", city_id=52))
    foods.append(Food(name="Milanesa", image="https://i.pinimg.com/564x/1f/15/d8/1f15d8e337068524aded38d6209070d8.jpg", description="Breaded and fried meat cutlets, typically made with beef or chicken, served with mashed potatoes or salad.", restaurant_recommendation="El Preferido de Palermo", city_id=52))

    # Sao Paulo
    foods.append(Food(name="Pastel", image="https://i.pinimg.com/564x/76/bf/bc/76bfbc2424bcee6ddfb4b56f6d139568.jpg", description="Deep-fried pastry filled with various savory fillings, such as cheese, meat, or heart of palm.", restaurant_recommendation="Feira da Liberdade", city_id=53))
    foods.append(Food(name="Virado à Paulista", image="https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Virado_a_paulista.jpg/1920px-Virado_a_paulista.jpg", description="Traditional dish consisting of beans, rice, pork chops, sausage, collard greens, and a fried egg, a classic meal in Sao Paulo.", restaurant_recommendation="Bar do Biu", city_id=53))
    foods.append(Food(name="Coxinha de Frango", image="https://receitasimplesefacil.com.br/wp-content/uploads/2022/02/Coxinha-de-Frango-scaled.jpg", description="Chicken croquette with a dough filled with shredded chicken, shaped like a drumstick.", restaurant_recommendation="Veloso", city_id=53))

    # Lima
    foods.append(Food(name="Ceviche", image="https://www.peruhop.com/wp-content/uploads/La-Mar-ceviche-Small-2.jpg", description="Fresh raw fish marinated in citrus juice, typically seasoned with onions, chili peppers, and cilantro.", restaurant_recommendation="La Mar", city_id=54))
    foods.append(Food(name="Lomo Saltado", image="https://www.seriouseats.com/thmb/RCkiNb_SbnrgTdupIh7NsLvAvrg=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__serious_eats__seriouseats.com__2019__03__20190321-lomo-saltado-vicky-wasik-28-68ac118a03324091afed4205428ddf4e.jpg", description="Stir-fried beef with onions, tomatoes, and french fries, often served with rice.", restaurant_recommendation="Tanta", city_id=54))
    foods.append(Food(name="Anticuchos", image="https://www.eatperu.com/wp-content/uploads/2022/01/peruvian-beed-heart-kebab-recipe.jpg", description="Grilled skewers of marinated meat, usually beef heart, served with potatoes and corn.", restaurant_recommendation="Panchita", city_id=54))

    # Bogota
    foods.append(Food(name="Ajiaco", image="https://www.thespruceeats.com/thmb/LkZa7ts4OhNdo4n6vIQpiOcfasw=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/colombian-chicken-and-potato-stew-4120146-hero-01-d6dcdf2fe44342d9893b25659ad041c7.jpg", description="Hearty soup made with chicken, potatoes, corn, and guascas herb, often served with avocado and capers.", restaurant_recommendation="La Puerta Falsa", city_id=55))
    foods.append(Food(name="Bandeja Paisa", image="https://popmenucloud.com/cdn-cgi/image/width%3D3840%2Cheight%3D3840%2Cfit%3Dscale-down%2Cformat%3Dauto%2Cquality%3D60/sqbhvkor/e1a2dfb7-8dd1-4218-8a34-acfee78bed85.jpg", description="Traditional platter consisting of rice, beans, grilled steak, chorizo, fried pork belly, plantains, arepa, avocado, and a fried egg.", restaurant_recommendation="Andres Carne de Res", city_id=55))
    foods.append(Food(name="Arepa", image="https://www.xtremefoodies.com/sites/default/files/Arepa.jpg", description="Cornmeal patty served with various fillings, such as cheese, meat, or eggs, a staple food in Colombia.", restaurant_recommendation="La Puerta Falsa", city_id=55))

    # Santiago
    foods.append(Food(name="Completo", image="https://i0.wp.com/tarasmulticulturaltable.com/wp-content/uploads/2016/06/Completo-Italiano-Chilean-Italian-Style-Hot-Dog-2-of-3-1.jpg?w=1300&ssl=1", description="Chilean-style hot dog topped with avocado, mayonnaise, sauerkraut, and tomato.", restaurant_recommendation="Fuente Alemana", city_id=56))
    foods.append(Food(name="Pastel de Choclo", image="https://www.comedera.com/wp-content/uploads/2022/12/Pastel-de-choclo-chileno.jpg", description="Corn and meat pie topped with sugar, a traditional dish in Chile.", restaurant_recommendation="Las Delicias de Quirihue", city_id=56))
    foods.append(Food(name="Cazuela", image="https://www.tasteofhome.com/wp-content/uploads/2018/01/Cazuela_EXPS_MIOPBZ17_5633_B10_012_3b.jpg?fit=700,1024", description="Hearty soup made with meat, potatoes, corn, pumpkin, and various vegetables, a popular Chilean comfort food.", restaurant_recommendation="El Hoyo", city_id=56))

    # Cartagena
    foods.append(Food(name="Arepas de Huevo", image="https://www.mycolombianrecipes.com/wp-content/uploads/2023/03/Arepa-de-Huevo-Recipe.jpg", description="Fried cornmeal patties filled with scrambled eggs, a popular snack in Cartagena.", restaurant_recommendation="La Cocina de Pepina", city_id=57))
    foods.append(Food(name="Sancocho de Pescado", image="https://cdn.colombia.com/gastronomia/2011/07/28/sancocho-de-pescado-1642.webp", description="Fish stew made with coconut milk, yuca, plantains, and various spices, a traditional dish in Cartagena.", restaurant_recommendation="La Mulata", city_id=57))
    foods.append(Food(name="Camarones al Ajillo", image="https://diethood.com/wp-content/uploads/2023/01/camarones-al-ajillo-garlic-shrimp-1.jpg", description="Garlic shrimp sautéed in olive oil, often served with rice or bread, a popular seafood dish in Cartagena.", restaurant_recommendation="La Cevicheria", city_id=57))

    # Quito
    foods.append(Food(name="Locro de Papa", image="https://www.bonella.com.ec/-/media/Project/Upfield/Brands/Rama/Rama-EC/Assets/Recipes/sync-img/1e7b3493-d630-421a-9c3a-35156540d88d.jpg?rev=d860b5d4b7d444bdb24564d04a242a53&w=900", description="Creamy potato soup with cheese, avocado, and crispy pork skin, a traditional dish in Ecuador.", restaurant_recommendation="Cafe Dios No Muere", city_id=58))
    foods.append(Food(name="Cuy", image="https://www.thedailymeal.com/img/gallery/what-is-cuy/crop%203285113200_d40e7500bb_o.jpg", description="Roasted guinea pig, a unique delicacy in Ecuador.", restaurant_recommendation="El Crater", city_id=58))
    foods.append(Food(name="Encebollado", image="https://blog.amigofoods.com/wp-content/uploads/2020/09/encebollado-ecuadorian-stew.jpg", description="Fish soup made with albacore tuna, yuca, onions, and spices, often served with pickled onions and avocado slices.", restaurant_recommendation="Lo de Carlitos", city_id=58))
    ...
    foods.append(Food(name="Moqueca de Camarão", image="https://skinnyspatula.com/wp-content/uploads/2021/06/Brazilian_Prawn_Stew3.jpg", description="Creamy shrimp stew cooked with coconut milk, palm oil, peppers, onions, and tomatoes, a traditional dish in Bahia.", restaurant_recommendation="Restaurante Yemanjá", city_id=59))
    foods.append(Food(name="Acaí na Tigela", image="https://images.food52.com/j9NLFmC-c-Yi1UK7nlvZxON9Hww=/2016x1344/filters:format(webp)/a74f268b-0ef7-49be-9872-f857001d43ad--tumblr_n2wggbyc4Q1reeddko2_1280.jpg", description="Frozen acai berry puree topped with granola, banana, and other fruits, a popular Brazilian snack.", restaurant_recommendation="Açaí Concept", city_id=59))

    # Lisbon
    foods.append(Food(name="Pastel de Nata", image="https://spanishsabores.com/wp-content/uploads/2019/06/Pasteis-de-nata-2397-Blog.jpg", description="Creamy custard tart with a caramelized top, a famous Portuguese pastry.", restaurant_recommendation="Pasteis de Belém", city_id=60))
    foods.append(Food(name="Bacalhau à Brás", image="https://www.foodandwine.com/thmb/TdZP92mInzQmKFUWLfu1zW3RWB4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/201501-xl-bacalhau-a-bras-2ff72a7a6ae14518b2dcd7509a52b618.jpg", description="Shredded codfish sautéed with onions, potatoes, eggs, and olives, a classic Portuguese dish.", restaurant_recommendation="A Brasileira", city_id=60))
    ...
    users.append(User(username='eylemaytas', password_hash=pw_hash))
